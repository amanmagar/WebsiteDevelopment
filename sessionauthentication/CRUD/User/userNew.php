...
<?php
require 'connect.php';
$email =$username=$password =$confirm=$encrypt=$result="";
...
if($_SERVER["REQUEST_METHOD"] = "POST")
{
  ...
  if ($emailError =="" && $usernameError =="" && $passwordError =="" && $confirmPasswordError== "") {
    $sql="INSERT INTO tblusers (Email,Username,Password) VALUES ('$email','$username','$encrypt')";

    if (mysqli_query($conn, $sql)) {
        $result="new user has been added successfully";
    } else {
