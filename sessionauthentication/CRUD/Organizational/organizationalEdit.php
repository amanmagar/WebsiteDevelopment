...
<head>
    ...
    <title>Personal Input Form</title>
...
$sql = "SELECT * from tblpersonal where PersonalId = $personalid ";
$result = mysqli_query($conn, $sql);
$dob=date("Y-m-d");
$name =$address=$profession=$contact="";
...
if($_SERVER["REQUEST_METHOD"] = "POST")
{
  ...
  if ($nameError =="" && $addressError =="" && $dobError =="" && $professionError== "" && $contactError=="") {
    $sql="UPDATE  tblpersonal set Name = '$name',Address = '$address',DOB= '$dob',Profession='$profession',Contact='$contact'where PersonalId = $personalid ";
